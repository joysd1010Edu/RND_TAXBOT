    ...
    <div className="space-y-6">
      ...
      <div className="space-y-1">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white">
          Core R&D Activities - Q2
        </h2>
        <p className="text-sm text-gray-600 dark:text-gray-400">
          Describe your R&D activities for Q2
        </p>
      </div>

      {/*========================= Core Activities Description =========================*/}
      <div className="space-y-2">
        <Label htmlFor="q2.coreActivitiesDescription">
          Describe the core R&D activities undertaken in Q2
      ...
      <div className="space-y-2">
        <Label htmlFor="q2.systematicProgression">
      ...
      {/*========================= Outcomes =========================*/}
      <div className="space-y-2">
        <Label htmlFor="q2.outcomes">
          What were the outcomes and findings in Q2?
          <span className="text-red-500">*</span>
        </Label>
